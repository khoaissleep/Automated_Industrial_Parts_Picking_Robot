...
data_new = Path("/home/khoa_is_sleep/screws/DATA/data_new")  # Thư mục chứa ảnh & nhãn gốc
data_val = Path("/home/khoa_is_sleep/screws/DATA/data_val")  # Thư mục chứa dữ liệu validation
...
list_imgs_path = list((data_new / "images").glob("*.jpg"))  # Hoặc "*.png" nếu dùng PNG

# Chia 20% dữ liệu cho validation
len_val_data = len(list_imgs_path) // 10
...
for img_path in list_imgs_path_val:
    label_path = data_new / "labels" / f"{img_path.stem}.txt"
